...
import { CreateTransferUserController } from '../modules/statements/useCases/createTransfer/CreateTransferUserController';
...
const createTransferUserController = new CreateTransferUserController();
...
statementRouter.post('/transfer/:recieve_userId', createTransferUserController.execute);
